...
public class AccountStatusBodyguard extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_account_state_bodyguard);
		setTitle("Bodyguard");
		...
		btnUpgrade.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (flag == 0) {
					...
					Intent intent = new Intent(AccountStatusBodyguard.this, LocationActivity.class);
	...
	class LoginJSON extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(AccountStatusBodyguard.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (status.equals("1")) {
				...
				if (date1.compareTo(date2) == 0) {
					...
					//btnUpgrade.setText("Upgrade Account");
					flag = 0;
				}
			} else {
				Toast.makeText(AccountStatusBodyguard.this, "Oops! Try again later.", Toast.LENGTH_SHORT).show();
			}
		}
	}
	...
	class UpgradeRequestJSON extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog1 = new ProgressDialog(AccountStatusBodyguard.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (status.equals("1")) {
				final Dialog dialog = new Dialog(AccountStatusBodyguard.this);
